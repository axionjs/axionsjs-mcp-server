import type { AxionsRegistryItem } from "./types.js";
import {
...
export async function generatePageWithComponents(
  pageType: "dashboard" | "landing" | "auth" | "profile" | "settings",
  components: string[],
  options: ComponentGenerationOptions = {}
): Promise<{
  pageCode: string;
  ...
  try {
    const resolvedComponents: AxionsRegistryItem[] = [];
...
export default function Auth() {
  ...
  return (
    pageTemplates[pageType as keyof typeof pageTemplates] ||
